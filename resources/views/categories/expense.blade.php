@include('partials.master-header')
    ...
    <div class="col-md-6">
        <div class="box box-success">
            ...
            <div class="box-body">
                {{ Form::open(array('route'=>'post_category')) }}
                @if($errors->any())
                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach($expenses as $exp )
                            <tr>
                                ...
                                <td>{{ $exp->name }}</td>
                                <td>{{ link_to_route('edit_category','Edit',array($exp->id),array('class'=>'btn btn-warning')) }}</td>
                                <td>
                                    {{ Form::open(array('method'=>'get','route'=>array('delete_category',$exp->id))) }}
